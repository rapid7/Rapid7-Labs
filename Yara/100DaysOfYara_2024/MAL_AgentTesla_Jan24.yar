...
rule SUS_Windows_Vault_Guids_Jan24 {
    meta:
...
rule SUS_Browser_References_Jan24 {
    meta:
...
rule SUS_Special_Key_References_Jan24 {
    meta:
        description = "Detects keyboard reference strings observed in AgentTesla payload."
        author = "Matt Green - @mgreen27"
        date = "2024-01-18"
        artifact = "Windows.Detection.Yara.Process"
        hash1 = "ebe2a77dab04458defd4d8f7760abda79a507ab0168d68a2930f9d7b1120127e"
...
rule SUS_Application_References_Jan24 {
    meta:
...
rule MAL_AgentTesla_Jan24
{
    ...
    strings:
        ...
        $s06 = "Berkelet DB" wide fullword
        $s07 = " 1.85 (Hash, version 2, native byte-order)" wide fullword
        $s08 = "SQLite format 3" wide fullword
